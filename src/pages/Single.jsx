    ...
    if (loading) {
        return (
            <div className="container text-center mt-5">
                ...
                <p className="mt-2 text-warning">Cargando detalles...</p>
            </div>
        );
    }
    ...
    if (error) {
        return (
            <div className="container text-center mt-5 alert alert-danger">
                <p>{error}</p>
                <Link to="/">
                    <button className="btn btn-primary mt-3">Volver a la Home</button>
                </Link>
            </div>
        );
    }
        ...
        <div className="container mt-5">
            <div className="row bg-dark text-light p-4 rounded shadow-lg">
                ...
                <div className="col-md-7">
                    ...
                    <Link to="/">
                        <button className="btn btn-primary mt-4">Volver a la Home</button>
                    </Link>
                </div>
            </div>
        </div>
